...
/**
 * 
 * Käyttöliittymän yhteystietotaulun ja varsinaisen yhteystietodatan välissä
 * oleva malli. Tämän avulla taulu pääsee käsiksi varsinaiseen dataan.
 * 
...
public class ContactInfoTableModel extends AbstractTableModel {
	...
	private String[] columnNames = { "First name", "Last name", "Nickname",
			"Email", "Phone number", "Address", "Tags" };
	...
	public Object getValueAt(int row, int column) {
		...
		String[] columns = new String[] { item.getFirstName(),
				item.getLastName(), item.getNickname(), item.getEmail(),
				item.getPhoneNumber(), item.getAddress(), item.getTags()
