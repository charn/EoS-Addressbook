...
public class CSVFileHandler
{
	 ...
	 * @author toittine
	 */
	public CSVFileHandler(JFrame pf, String cmd, AddressbookController controller)
	{
		jframe = pf;
		this.cmd = cmd;
			...
			{				
				...
				for(int i =0; i < sitems.length ; i++)
				{
					...
					switch (i)
					{
						...
						case 5: nickname = s;		break;
						case 7: email = s;			break;
						case 9: phonenumber = s;	break;
						case 11: address = s;		break;
						case 13: tags = s;			break;
						default:
							break;
					}
				}//for
	...
	private void exportAddressbookItems(String filename) 
	{
		try { 
			...
			for (ListIterator<AddressbookItem> it = controller.getItems().listIterator(); it.hasNext(); )
			{
